...
public class ColorSelectorScreen extends Screen
{
	...
	private final float[] rgbMinS;
	private final float[] rgbMaxS;
	private final float[] rgbMinB;
	private final float[] rgbMaxB;
	...
	protected void init()
	{
		...
		colorField = new TextFieldWidget(font, x + 11, y + 20, 116, 9, title);
		...
		addButton(new Button(x + 9, y + 79, 41, 20, new TranslationTextComponent("gui.cancel"), b -> {
			setColor(prevColor, false);
			minecraft.displayGuiScreen(parent);
		}));

		addButton(new Button(x + 51, y + 79, 37, 20, new StringTextComponent("Def"), b -> setColor(type.defaultColor, true)));
		addButton(new Button(x + 89, y + 79, 41, 20, new TranslationTextComponent("gui.done"), b -> minecraft.displayGuiScreen(parent)));
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
	{
		...
		bufferbuilder.pos(x + 10, y + 44, 0D).color(1F, 1F, 1F, 1F).tex(0F, 1F).endVertex();
		bufferbuilder.pos(x + 129, y + 44, 0D).color(1F, 1F, 1F, 1F).tex(1F, 1F).endVertex();
		bufferbuilder.pos(x + 129, y + 33, 0D).color(1F, 1F, 1F, 1F).tex(1F, 0F).endVertex();
		bufferbuilder.pos(x + 10, y + 33, 0D).color(1F, 1F, 1F, 1F).tex(0F, 0F).endVertex();
		tessellator.draw();
		...
		RenderSystem.color4f(1F, 1F, 1F, 1F);
		minecraft.getTextureManager().bindTexture(TEXTURE);
		blit(matrixStack, x + 10 + (int) (119F * hsb[0]), y + 33, 0, 108, 1, 11);
		blit(matrixStack, x + 10 + (int) (119F * hsb[1]), y + 47, 0, 108, 1, 11);
		blit(matrixStack, x + 10 + (int) (119F * hsb[2]), y + 61, 0, 108, 1, 11);

		super.render(matrixStack, mouseX, mouseY, partialTicks);
		colorField.render(matrixStack, mouseX, mouseY, partialTicks);

		String t = title.getString();
		font.drawString(matrixStack, t, x + 9, y + 7, 4210752);
