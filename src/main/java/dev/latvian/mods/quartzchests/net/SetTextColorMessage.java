 ...
 */
public class SetTextColorMessage
{
	private BlockPos pos;
	private int color;

	public SetTextColorMessage(BlockPos p, int c)
	{
		pos = p;
		color = c;
	}

	public SetTextColorMessage(PacketBuffer buf)
	{
	...
	public void handle(Supplier<NetworkEvent.Context> context)
	{
		context.get().enqueueWork(() -> {
			...
			{
				((QuartzChestEntity) entity).textColor = color;
				entity.markDirty();
